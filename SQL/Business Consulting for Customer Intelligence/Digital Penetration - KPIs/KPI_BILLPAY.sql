...
WHERE T1.DAT ACCT BETWEEN 2018-10-01 AND 2018-10-31
    ...
    AND 
    ((T1.CODE IN ('425') AND T1.TRANCODE IN ('0021','0756')
    ...
    AND (LEN(T1.CHECK) = 6) AND (SUBSTR(T1.CHECK,1,2) = '90'))                                                                                                             -- BILLPAY PAPER (CHECK) TRANSACTIONS
    OR ((T1.CODE IN ('527') AND T1.TRANCODE IN ('0032','0739','0753')) AND ((SUBSTR(T1.COMP OBS ATM,1,11) = 'CO REF- CKF') AND (SUBSTR(T1.COMP OBS ATM,20,3) = 'POS')))    -- BILLPAY ELECTRONIC TRANSACTIONS
    )
